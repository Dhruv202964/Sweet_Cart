...
const Messages = () => {
  ...
  // 1. Fetch Messages (WITH SAFETY CHECK)
  useEffect(() => {
    fetch('http://localhost:5000/api/messages')
      ...
      .catch(err => {
        ...
        setMessages([]); // Fallback to empty array to prevent WSOD crash
      });
  }, []);
    ...
    <div className="p-8 bg-orange-50 min-h-screen">
      ...
      <div className="flex justify-between items-end mb-8">
        ...
        <div className="bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-200">
          ...
          <span className="text-2xl font-bold text-red-600 ml-2">{messages.length}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {messages.length === 0 ? (
            ...
            <div 
              ...
              className="bg-white p-6 rounded-2xl shadow-lg border-l-8 border-red-600 hover:shadow-xl transition relative group cursor-pointer flex flex-col h-full hover:-translate-y-1"
            >
                ...
                <div className="flex justify-between items-start mb-4">
                    <div className="pr-8">
                        ...
                        <p className="text-[10px] font-bold text-red-600 uppercase tracking-wide mt-1">New Inquiry</p>
                    </div>
                </div>
                ...
                <div className="border-t pt-4 flex items-center justify-between">
                    ...
                    <button 
                      ...
                      className="bg-red-600 text-white p-2 rounded-lg hover:bg-red-800 transition shadow-sm"
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex justify-between items-start p-6 border-b border-gray-100 bg-gray-50">
              <div className="pr-4">
                <span className="text-xs font-bold text-red-600 uppercase tracking-wider mb-1 block">Subject</span>
            ...
            <div className="p-6 border-t border-gray-100 bg-white flex justify-between items-center">
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-red-600 hover:bg-red-800 text-white font-bold py-2.5 px-5 rounded-xl transition shadow-lg"
              >
